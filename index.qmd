...
**Moisture content.** Gill and muscle tissues moisture content showed similar results to plasmatic protein dosage, with gill moisture concentrations being significantly higher than those observed at the reference site (Site 1; 82.82 ± 1.75%) at Sites 5 and 6 (mean values of 90.13 ± 1.19% and 93.89 ± 0.98%, Wilcoxon rank-sum test; p \< 0.004). No significant increases were detected at Sites 2, 3, or 4 (84.35 ± 1.60%, 85.63 ± 1.94%, and 82.84 ± 0.75%, respectively; p \> 0.1 in all cases).
