...
**Moisture content.** Gill and muscle tissues moisture content showed similar results, with gill moisture concentrations being significantly higher than those observed at the reference site (Site 1; 82.82 ± 1.75%) at Sites 6 and 5 (mean values of 93.89 ± 0.98% and 90.13 ± 1.19%, one-sided Welch's t-test; p \< 0.001 and p = 0.002, respectively). No significant increases were detected at Sites 2, 3, or 4 (84.35 ± 1.60%, 85.63 ± 1.94%, and 82.84 ± 0.75%, respectively; p \> 0.05 in all cases). The muscle moisture concentrations at the reference site averaged 80.31 ± 1.48%. Significantly higher values were observed at Sites 6 and 5, where mean moisture concentrations reached 86.02 ± 2.49% and 84.29 ± 0.88%, respectively (one-sided Welch's t-test; p = 0.034 and p = 0.018, respectively). In contrast, moisture concentrations at Sites 2, 3, and 4 (80.11 ± 0.66%, 80.58 ± 0.94%, and 82.38 ± 0.62%, respectively) did not differ significantly from those at the reference site (p \> 0.05) (@fig-prot_th).
