...
![Total protein (mg) variance of data inside and outside ReBio Guaribas.](imagens/Figura 3.png){#fig-boxtpinandout}

![Boxplot with total protein data of collected fish from the sampling sites inside (green) and outside ReBio Guaribas (red), including its respective grouping by similarity above each box.](imagens/Figura 4.png){#fig-boxtpsites}

![Moisture content (%) of tissues from sampling sites inside and outside the ReBio Guaribas, with the respective p-value between each locality.](imagens/Figura 5.png){#fig-mcsites}

![Boxplot with gill and muscle moisture content data of fish collected from sites inside (green) and outside ReBio Guaribas (red), with its respective grouping by similarity above each box.](imagens/Figura 6.png){#fig-boxmmcsites}

![Average fluorescence data from sampling sites inside and outside the ReBio Guaribas, expressed by relative fluorescence units/milligrammes of tissue (gill).](imagens/Figura 7.png){#fig-fluorescence}

![Boxplot with the MXR phenotype activity data of fish collected from sites inside (green) and outside the ReBio Guaribas (red), with its respective grouping by similarity above each box.](imagens/Figura 8.png){#fig-boxmxr}
