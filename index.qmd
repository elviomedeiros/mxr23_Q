...
The scientific research follows the model shown in the figured cross-referenced here (@fig-pesquisa). Authorship of this paper is based on @credit-contributorroletaxonomya.
