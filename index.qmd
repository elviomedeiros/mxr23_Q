...
<<<<<<< HEAD
Principal Component Analysis (PCA) described the overall structure of the study sites and identified the main environmental characteristics responsible for their differentiation in relation to preservation status @fig-hab_PCA_fviz. The first two axes explained 52.4% of the total variance, with the first axis (30.9%) representing a gradient associated with habitat condition and channel morphology. Along this axis, Type I sites were characterized by higher dissolved oxygen concentration, altitude, and the presence of hanging vegetation, indicating more preserved and structurally complex environments, while Type III and IV sites were associated with larger channel dimensions, including greater depth and width, as well as sandy substrates, reflecting more altered conditions. The second axis (21.5%) captured the variation related to habitat structure and local environmental characteristics, with positive values ​​associated with macrophytes, algae, and organic detritus, and negative values ​​related to higher water velocity, turbidity, and root mass. This axis highlighted the differences within the site categories, particularly among the impacted sites, suggesting the influence of environmental heterogeneity at the local scale. In general, reference sites (Type I) were associated with better water quality and preserved habitat characteristics, Type III sites presented intermediate characteristics, and Type IV sites were most strongly related to degraded conditions, including increased turbidity, sandy substrates, and altered channel morphology.
=======
Principal Component Analysis described the overall structure of the study sites and the most important features in separating them in terms of their physical and chemical variables, site morphometry, sediment composition, and marginal habitat structure. PCA explained 52.4% of the variance in the environmental variables, with the first axis (30.9%) showing a clear spatial gradient. This primary axis separated sites P08 and P10—characterized by greater stream width, depth, and sandy substrate—from sites P05, P06, and P07, which were associated with muddy substrates, higher DO, and dense overhanging vegetation. The second axis (21.5%) was primarily driven by local habitat features, separating site P09, which was strongly associated with root masses and water velocity, from sites characterized by attached algae and macrophytes. The overall multivariate conditions did not differ significantly between the interior and the surroundings of the reserve, although specific local variables such as water turbidity, leaf litter cover, and attached algae were important in explaining specific sites across the conservation unit's boundary.
>>>>>>> 477b69a (Ali: Environmental variables)
...
mxr23 <- read.xlsx("C:/Users/lices/Documents/UEPB V - MESTRADO/Github/mxr23_Q/data/rebio23-peixes_5-10.xlsx",
                   rowNames = T,
                   colNames = T,
                   sheet = "peixes-fisio")
