...
![](imagens/Figura 3.png "Total protein (mg) variance of data inside and outside ReBio Guaribas."){#fig-fig.2}

![](imagens/Figura 4.png "Boxplot with total protein data of collected fish from the sampling sites inside (green) and outside ReBio Guaribas (red), including its respective grouping by similarity above each box."){#fig-fig.3}

![](imagens/Figura 5.png "Moisture content (%) of tissues from sampling sites inside and outside the ReBio Guaribas, with the respective p-value between each locality."){#fig-fig.4}

![](imagens/Figura 6.png "Boxplot with gill and muscle moisture content data of fish collected from sites inside (green) and outside ReBio Guaribas (red), with its respective grouping by similarity above each box."){#fig-fig.5}

![](imagens/Figura 7.png "Average fluorescence data from sampling sites inside and outside the ReBio Guaribas, expressed by relative fluorescence units/milligrammes of tissue (gill)."){#fig-fig.6}

![](imagens/Figura 8.png "Boxplot with the MXR phenotype activity data of fish collected from sites inside (green) and outside the ReBio Guaribas (red), with its respective grouping by similarity above each box."){#fig-fig.7}
