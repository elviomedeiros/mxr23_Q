...
hab_gttable <- read_excel(
  ...
  sheet = "tabela_final",
  range = "A1:G29") #ajustar para o tamanho da tabela final 
hab_gttable
library(gt)
...
Gill and muscle tissues moisture content showed similar results, with gill moisture concentrations being significantly higher than those observed at the reference site (Site 1; 82.82 ± 1.75%) at Sites 6 and 5 (mean values of 93.89 ± 0.98% and 90.13 ± 1.19%, one-sided Welch's t-test; p < 0.001 and p = 0.002, respectively). No significant increases were detected at Sites 2, 3, or 4 (84.35 ± 1.60%, 85.63 ± 1.94%, and 82.84 ± 0.75%, respectively; p > 0.05 in all cases). The muscle moisture concentrations at the reference site averaged 80.31 ± 1.48%. Significantly higher values were observed at Sites 6 and 5, where mean moisture concentrations reached 86.02 ± 2.49% and 84.29 ± 0.88%, respectively (one-sided Welch's t-test; p = 0.034 and p = 0.018, respectively). In contrast, moisture concentrations at Sites 2, 3, and 4 (80.11 ± 0.66%, 80.58 ± 0.94%, and 82.38 ± 0.62%, respectively) did not differ significantly from those at the reference site (p > 0.05).
...
Rhodamine B concentrations differed among sampling sites relative to the reference site (Site 1), which exhibited a mean concentration of 38,396.35 ± 4,749.86 RFU mg⁻¹. Significantly higher concentrations were observed at Sites 4, 5 and 6, with mean values of 73,113.69 ± 5,311.65, 67,116.05 ± 7,023.54 RFU mg⁻¹ and 62,929.41 ± 6,196.21, respectively (one-sided Welch's t-test; p < 0.003). In contrast, Rhodamine B concentrations at Sites 2 and 3 (16,978.11 ± 2,139.98 and 20,973.12 ± 2,373.55 RFU mg⁻¹, respectively) were not significantly greater than those observed at the reference site (p > 0.05). The highest mean concentration was recorded at Site 4, corresponding to an approximately 1.9-fold increase relative to the reference site.
...
![Location of sampling sites within (Site 1 - 06°43'06,58555'' S, 35°10'54,70041''W -, Site 2 - 06°42'38,71927''S, 35°10'38,68013''W - and Site 3 - 06°43'06,58555''S, 35°10'54,70041''W) and surrounding the REBIO Guaribas (Site 4 - 06°41'46,29119''S, 35°10'36,09933''W -, Site 5 - 06°40'56,47593''S, 35°10'27,84963''W - and Site 6 - 06°40'18,97010''S, 35°10'34,68148''W).](imagens/mapa_final.png){#fig-mapa}
...
<summary>Fig.: Counts of number of individuals per species and biomarker use</summary>

![Counts of number of individuals per species and biomarker use (MXR = MXR phenotype activity and Moisture = Plasmatic protein dosage and moisture content) for each study site.](fig-counts.png){#fig-counts}

</details>

<details>

<summary>Fig.: Total protein (mg) variance</summary>

![Total plasmatic proteins (mg) variance by sampling site and fish species.](fig-prot_tots.png){#fig-prot_tots}
...
![Gill and muscle moisture content (%) by sampling site and fish species.](fig-prot_th.png){#fig-prot_th}
...
![Average fluorescence of rhodamin B expressed by relative fluorescence units/milligrammes of gill tissue of fish by sampling site.](fig-rodam.png){#fig-rodam}
...
<summary>Fig.: Environmental data table</summary>
